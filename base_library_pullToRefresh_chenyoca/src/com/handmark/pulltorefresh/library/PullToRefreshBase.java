...
//				getLoadingLayoutProxy().setLastUpdatedLabel("上次更新时间:" + label);
...
//				getLoadingLayoutProxy().setLastUpdatedLabel("上次更新时间:" + label);
	...
	protected void setBaseRefreshTime(String time) {
		getLoadingLayoutProxy().setLastUpdatedLabel("最后更新: " + time);
	}
